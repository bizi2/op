...
int main() {
    ...
    CString str_2("HELLO");
    CString str_3(str_2);
    CString str_4("CHTO-TO", 10);
    CString str_5(20, '*');
    CString str_6(str_4, 5, 3);

    std::cout << "CS1\n";
    str_1.print();
    std::cout << std::endl << "CS2(\"Hello\");\n";
    str_2.print();
    std::cout << std::endl << "CS3;\n";
    str_3.print();
    std::cout << std::endl << "CS4";
    str_4.print();
    std::cout << std::endl << "CS5(20, \'*\');\n";
    str_5.print();
    std::cout << std::endl << "CS6(str_4, 5, 3);\n";
    str_6.print();
    std::cout << std::endl;
